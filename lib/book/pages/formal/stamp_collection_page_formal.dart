...
import 'package:kdf/book/pages/abstract/stamp_collection_page_abstract.dart';
...
class _StampCollectionPageFormalState extends StampCollectionPageAbstractState<StampCollectionFormalPage> {
  ...
  Widget build(BuildContext context) {
    ...
    if(items.isEmpty) {
      body = new Center(child: new Text("Kütüphaneniz boş"));
    } else {
    ...
    return new Scaffold(
      appBar: new AppBar(
        title: new Text("Kütüphane", style: const TextStyle(color: Colors.black),),
