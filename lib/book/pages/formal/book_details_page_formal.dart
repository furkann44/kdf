...
import 'package:kdf/book/pages/abstract/book_details_page_abstract.dart';
        ...
        child: new Padding(
          ...
          child: new Column(
            ...
            children: <Widget>[
                ...
                children: <Widget>[
                  ...
                  new Expanded(
                    child: new IconButtonText(
                      ...
                      text: widget.book.starred? "Çıkar"  :"Kütüphaneye Ekle",
              ...
              new Divider(height: 32.0, color: Colors.black38,),
              new Text("Açıklama", style: const TextStyle(fontSize: 20.0, fontFamily: "CrimsonText"),),
              new SizedBox(height: 8.0,),
              new Text(widget.book.description, style: const TextStyle(fontSize: 16.0),),
              new SizedBox(height: 25.0,),
              new Text("Sayfa Sayısı:  ${widget.book.pageCount}", style: const TextStyle(fontSize: 18.0, fontFamily: "CrimsonText"),),
              new SizedBox(height: 25.0,),
              new Text("ISBN:  ${widget.book.isbn}", style: const TextStyle(fontSize: 18.0, fontFamily: "CrimsonText"),),
            ],
          ),
        ),
      ),
