...
import 'package:kdf/book/data/database.dart';
...
class Repository {
  ...
  Book parseNetworkBook(jsonBook) {
    ...
    return new Book(
      ...
      subtitle: subtitle, 
      pageCount: pageCount,
      isbn: jsonBook["volumeInfo"]["industryIdentifiers"] != null? jsonBook["volumeInfo"]['industryIdentifiers'][0]['identifier']: "",
      webReaderLink: jsonBook["accessInfo"]["webReaderLink"],
      buyLink: jsonBook["saleInfo"] != null? jsonBook["saleInfo"]["buyLink"]: "",
    );
  }
