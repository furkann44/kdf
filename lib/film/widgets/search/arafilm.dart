...
import 'package:kdf/film/widgets/search/search_itemf.dart';
import 'package:rxdart/rxdart.dart';

class SearchScreenf extends StatefulWidget {
  @override
  _SearchPageState createState() => _SearchPageState();
}

class _SearchPageState extends State<SearchScreenf> {
  ...
  Widget _buildContentSection() {
    switch (_currentState) {
      case LoadingState.WAITING:
        return Center(child: Text("yorumunu ekle"));
        ...
        return (_resultList == null || _resultList.length == 0)
            ...
            : ListView.builder(
                ...
                itemBuilder: (BuildContext context, int index) =>
                    SearchItemCardf(_resultList[index]));
      default:
        return Container();
    }
  }
  ...
  AppBar _buildAppBar(BuildContext context) {
    return AppBar(
        title: Text('Hangi filmi arıyorsun?'),
